                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div>
                          <span class="text-caption text-grey-darken-2">{{
                            formatTimeAgo(applicant.job.updated_at)
                          }}</span>
                          <span
              ...
              <v-toolbar density="comfortable" class="bg-transparent px-2" flat>
                <v-row class="align-center px-3" style="min-width: 220px">
                  <v-btn
                    icon
                    size="small"
                    @click="router.replace('/admin/jobs/saved')"
                    elevation="0"
                    color="primary"
                    class="mr-2"
...
const fetchJobs = async (page = 1) => {
  ...
  params.value.expands =
    "job.company, job.region, job.salary_country, job.right_to_work.salary_country";
  ...
  fetchJobApplieds(jobs.value.map((job) => job.job.id));
};
