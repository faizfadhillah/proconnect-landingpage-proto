  ...
  <v-container fluid>
    ...
    <v-card elevation="0" rounded="lg">
      <v-card-title class="mb-3 font-weight-bold text-primary"
        >User Skill Passport</v-card-title
      >
        ...
        <v-row>
          <v-col cols="12">
            <div class="d-flex align-center justify-space-between mb-4">
              <v-text-field
                v-model="searchInput"
                placeholder="Search skill passport, user or email here"
                  ...
                  <v-card-text>
                    <v-row>
                      <v-col cols="12">
                        ...
                        <v-radio-group v-model="filters.status">
                          <v-row>
            ...
            <template v-slot:item.actions="{ item }">
              ...
              <div class="d-flex">
                <v-btn
                  ...
                  size="small"
                  rounded="lg"
                  @click="verifySkillPassport(item)"
                  >Verify</v-btn
                >
                <v-btn
                  ...
                  size="small"
                  rounded="lg"
                  @click="unverifySkillPassport(item)"
                  >Unverify</v-btn
                >
              </div>
            </template>
...
const entity = ref("user-skill-passports");
  ...
  try {
    ...
    const params = {
      ...
      filters: {
        ...
        orWhere: ["number", "user.email", "user.full_name"],
      },
      expands: "user",
...
const verifySkillPassport = async (item) => {
  try {
    await dialog.openDialog({
      title: "Verify Skill Passport",
      message: "Are you sure you want to verify this skill passport?",
...
const unverifySkillPassport = async (item) => {
  try {
    await dialog.openDialog({
      title: "Unverify Skill Passport",
      message: "Are you sure you want to unverify this skill passport?",
