...
export class CreateJobStepDto {
  ...
  @ApiProperty({
    ...
    example: JobStepsStatus.PENDING,
  })
  ...
  @IsString()
  @IsOptional()
  notes?: "Thank you for your interest in [Job Title] at [Company Name]. Please provide or update the required information in your profile to proceed to the next stage of recruitment.";
