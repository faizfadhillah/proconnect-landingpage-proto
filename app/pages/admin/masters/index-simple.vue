  ...
  <div class="master-settings-page">
    <v-container fluid class="pa-4">
      ...
      <div class="d-flex align-center justify-space-between mb-5">
        <div>
          <h2 class="font-weight-medium mb-1">Master Data</h2>
...
const handleSearchUpdate = (value) => {
  // Ensure search value is always a string (handle null/undefined from clearable)
  search.value = value || "";
};
...
const groupedEntities = computed(() => {
  ...
  entities.value.forEach((entity) => {
    ...
    if (!searchTerm || entity.title.toLowerCase().includes(searchTerm)) {
